            ...
            {subjects.map((subject) => {
              ...
              return (
                ...
                >
                  ...
                  {/* Submenu: Level List - hiện khi hover vào subject (desktop) hoặc click (mobile) */}
                  {hasLevels && ((isMobile && isExpanded) || (!isMobile && isHovered)) && (
                    <>
                      {isMobile ? (
                        // Mobile: Submenu hiện bên trong dropdown, dưới subject item
                        <div className="w-full bg-muted/30 border-t">
                          <div className="text-xs font-medium text-muted-foreground px-4 py-2 border-b bg-muted/50">
                            Level
                          </div>
                        ...
                        // Desktop: Submenu hiện bên phải như popover
                        <>
